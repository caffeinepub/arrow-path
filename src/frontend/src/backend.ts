...
export class Backend implements backendInterface {
    ...
    async getAllProgress(): Promise<Array<Progress>> {
    ...
    async getBestMoveCount(arg0: string): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBestMoveCount(arg0);
    ...
    async getHighestLevelReached(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getHighestLevelReached();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markLevelCompleted(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markLevelCompleted(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
